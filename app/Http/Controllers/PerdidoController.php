...
class PerdidoController extends Controller
{
    public function index()
    {
        ...
        return view('perdidos', compact('perfiles', 'posteados', 'servicioperfiles', 'servicios', 'productos'))
...
// 'servicio',
        return view('perdidos', compact('posteados','perfile', 'servicioperfile', 'servicioperfiles','servicios','productos','producto'));
    }
}
