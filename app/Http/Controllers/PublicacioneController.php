...
class PublicacioneController extends Controller
{
    public function index()
    {
        ...
        return view('publicaciones', compact('perfiles', 'posteados', 'servicioperfiles', 'servicios', 'productos'))
...
// 'servicio',
        return view('publicaciones', compact('posteados','perfile', 'servicioperfile', 'servicioperfiles','servicios','productos','producto'));
    }
}
