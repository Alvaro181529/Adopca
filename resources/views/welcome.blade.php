...
<body id="page-top antialiased">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top " id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">Adopca</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    {{-- <li class="nav-item"><a class="nav-link" href="#contact">Comentario</a></li> --}}
                    <li class="nav-item">
                        @if (Route::has('login'))
                            @auth
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Sistema web <strong>FOUND IT</strong> </h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    ...
                    <a class="btn btn-primary btn-xl" href="{{ url('/login') }}"> Ingreso</a>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-white-75 mb-4">Start Bootstrap has everything you need to get your new website up
            ...
            <div class="row g-0">
                @foreach ($posteados as $posteado)
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ url('perfil/' . $posteado->perfile->id) }}"
                            title="{{ $posteado->pos_titulo }}">
                            <img class="img-fluid" src=" {{ asset('storage') . '/' . $posteado->pos_img }}"
                                alt="..." />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">{{ $posteado->clasificado->cla_nombre }}
                                </div>
                                <div class="project-name">{{ $posteado->pos_titulo }}</div>
                            </div>
                        </a>
                    </div>
                @endforeach
